...
* Current vintage 
import delimited using "$repo_path\prepped_data\phi_premiums\\`nhe_vintage'\phi_premiums", clear 
save `merge_baseline', replace

* Previous vintage
import delimited using "$repo_path\prepped_data\phi_premiums\\`nhe_vintage_prev'\phi_premiums", clear 
...
order year prem_* pchange_prem_* ///
	gdp_* pop_* pc_* pcmed_* cpiumed_* inc_* ///
